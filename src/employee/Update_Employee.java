...
public class Update_Employee implements ActionListener {
    ...
    String id_emp;
    JComboBox jcb;
    String ed[]={"B.Tech","M.Tech","MCA","BE"};
...
//        super(0);
       ...
       /* t6=new JTextField();
        ...
        id15.add(t6);
       */
        jcb=new JComboBox(ed);
        jcb.setBounds(600,200,150,30);
        id15.add(jcb);
    ...
    void showData(String s)
    {
        try{
            ...
            if(rs.next())
            {
                ...
                jcb.setSelectedItem(rs.getString(8));
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==b && i==1)
        {
            try{
               conn c=new conn();
               //String h=(String)jcb.getSelectedItem();
                String str = "update employee set name='"+t1.getText()+"',fname='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',email='"+t5.getText()+"',education='"+jcb.getSelectedItem()+"',post='"+t7.getText()+"',aadhar='"+t8.getText()+"',emp_id='"+t9.getText()+"' where emp_id='"+id_emp+"'";
             //  String str="update employee set name='"+t1.getText()+"',fname='"+t2.getText()"',dob='"+dat+"',addess='"+t3.getText()+"',phone='"+t4.getText()+"',email='"+t5.getText()+"',education='"+t6.getText()+"',post='"+t7.getText()+"',aadhar='"+t8.getText()+"',emp_id='"+t9.getText()+"' where emp_id='"+id_emp+"'";
