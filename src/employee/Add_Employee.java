...
public class Add_Employee implements ActionListener{
    ...
    String ed[]={"B.Tech","M.Tech","BE","MCA"};
    ...
    public Add_Employee()
    {
        ...
        id1.setFont(new Font("serif",Font.BOLD,23));
        id15.add(id1);
        ...
        id2.setFont(new Font("serif",Font.BOLD,23));
        id15.add(id2);
        ...
        id3.setFont(new Font("serif",Font.BOLD,23));
        id15.add(id3);
        ...
        id4.setFont(new Font("serif",Font.BOLD,23));
        id15.add(id4);
        ...
        id5.setFont(new Font("serif",Font.BOLD,23));
        id15.add(id5);
        ...
        id6.setFont(new Font("serif",Font.BOLD,23));
        id15.add(id6);
        ...
        id7.setFont(new Font("serif",Font.BOLD,23));
        id15.add(id7);
        ...
        id9.setBounds(400,300,120,30);
        id9.setFont(new Font("serif",Font.BOLD,23));    
        id15.add(id9);
       ...
       */
        ...
        jcb.setBounds(600,300,150,30);
        id15.add(jcb);
        
        id10= new JLabel("Job Post");
        id10.setBounds(50,350,100,30);
        id10.setFont(new Font("serif",Font.BOLD,23));
        id15.add(id10);
        ...
        id11.setFont(new Font("serif",Font.BOLD,23));
        id15.add(id11);
        ...
        id12.setFont(new Font("serif",Font.BOLD,23));
        id15.add(id12);
